...
import SidebarFilters from '../filtre/filtre'
...
export default function AllArena() {
	...
	return (
		<Box className='py-16 px-4 md:gap-8 flex md:flex-row md:items-statrt justify-between'>
			<SidebarFilters onChange={setFilters} onPriceChange={setPriceRange} />
